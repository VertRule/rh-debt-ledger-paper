...
echo "[4/9] Fetching and comparing with origin/main..."
...
echo "[5/9] Checking required files..."
...
echo "[6/9] Checking forbidden artifacts are not tracked..."
...
echo "[7/9] Running redaction scan..."
...
echo "[8/9] Running exhibit digest verification..."
...
echo "[9/9] Running verify-all-exhibits..."
