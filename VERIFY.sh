...
echo "[5/8] Checking forbidden artifacts are not tracked..."
...
echo "[6/8] Running redaction scan..."
...
echo "[7/8] Running exhibit digest verification..."
...
# 8) Run verify-all-exhibits (soft dependency)
echo "[8/8] Running verify-all-exhibits..."
